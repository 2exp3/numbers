...
trngPage=function (ctrlVals, trials) {
  ...
  if (mobi==T){
    ...
    cajita1=paste0("<div class = \"",
                   ...
                   clickEnabled,\n trialNr,tipo);\"><table>","MENOR\nque 65", "</table></div></div>")
    cajita2=paste0("<div class = \"",
                   caj,"\"><div class = \"",
                   op,"\" id=\"opt2\"\n onmousedown=\"onOptionClick('opt2', 2, t, respTime,
                   clickEnabled,\n trialNr,tipo);\"><table>","MAYOR\nque 65", "</table></div></div>")
  ...
  list(
    ...
    fixedRow(column(12,align = "center",
                                  ...
                                  column(3, HTML(cajita1)) ,
                                  column(3, HTML(cajita2)) ,
                                  column(2, h1(""))
    )
    )
  ) 
